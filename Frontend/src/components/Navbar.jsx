...
const Navbar = () => {
  ...
  return (
    <div className="w-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex-shrink-0 flex items-center">
              <Link to="/customer/home" className="font-bold text-xl">
                MediTrack
              </Link>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-4">
              <Link to="/customer/home" className="hover:bg-blue-700 px-3 py-2 rounded-md text-sm font-medium">
                Home
              </Link>
              <button
                onClick={() => setShowUpload(!showUpload)}
                className="hover:bg-blue-700 px-3 py-2 rounded-md text-sm font-medium focus:outline-none"
              >
                Prescription
              </button>
              <Link to="/order" className="hover:bg-blue-700 px-3 py-2 rounded-md text-sm font-medium">
                Order
              </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-blue-600 pb-3 px-2">
            <div className="space-y-1">
              ...
              <button
                onClick={() => setShowUpload(!showUpload)}
                className="w-full text-left block px-3 py-2 rounded-md text-base font-medium hover:bg-blue-700 focus:outline-none"
              >
                Prescription
              </button>
      ...
      {/* Upload Prescription Toggle Area - Now centered */}
      {showUpload && (
