        ...
        <div className="mb-4">
          ...
          <div className="flex space-x-4">
            <button
              ...
              className={`flex items-center px-4 py-2 ${selectedFormat === 'PDF'
            ...
            <button
              ...
              className={`flex items-center px-4 py-2 ${selectedFormat === 'Excel'
            ...
            <button
              ...
              className={`flex items-center px-4 py-2 ${selectedFormat === 'CSV'
              ...
              <div className="flex justify-between items-center mb-6">
                <div className="flex space-x-2">
                  <button
                    ...
                    className={`py-2 px-4 rounded-md ${activeTab === 'overview'
                  ...
                  <button
                    ...
                    className={`py-2 px-4 rounded-md ${activeTab === 'analytics'
                      ? 'bg-blue-100 text-blue-700'
                      : 'bg-white text-gray-700 hover:bg-gray-100'
                      }`}
                  >
