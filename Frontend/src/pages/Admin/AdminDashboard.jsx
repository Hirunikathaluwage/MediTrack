...
import Notifications from "../../pages/Admin/NotificationPage";
      ...
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 text-sm">
            Data period: {reportData?.period || "All time"}
          </p>
          <p className="text-gray-600 text-sm">
            Records: {reportData?.totalRecords || "0"}
          </p>
        </div>
  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      try {
        ...
        console.error(" Failed to fetch inquiry stats");
      }
    };
  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      try {
        ...
        console.error(" Failed to fetch inquiry analytics");
      }
    };
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 bg-gray-50 min-h-screen">
        ...
        <div className="max-w-screen-xl mx-auto px-4 py-8">
                ...
                <>
                  ...
                  <div className="bg-white rounded-lg shadow-md p-6 mb-8">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <button
                        onClick={() =>
                          handleDownloadReport("Filtered Analytics")
                        }
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                      ...
                      <div className="bg-white rounded-lg shadow-md p-6">
                        <div className="flex justify-between items-center mb-4">
                          ...
                          <button
                            onClick={() =>
                              handleDownloadReport("Priority Breakdown")
                            }
                      ...
                      <div className="bg-white rounded-lg shadow-md p-6">
                        <div className="flex justify-between items-center mb-4">
                          ...
                          <button
                            onClick={() =>
                              handleDownloadReport("Inquiry Status")
                            }
                            className="text-sm text-blue-600 hover:text-blue-800 flex items-center"
                          >
                            <Download size={16} className="mr-1" />
          ...
          {activeSection === "view-inquiries" && <ViewInquiries />}
          {activeSection === "manage-inquiries" && <ManageInquiries />}
