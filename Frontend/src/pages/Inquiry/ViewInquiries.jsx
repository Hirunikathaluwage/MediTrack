  ...
  const handleResolve = async (inquiry) => {
    try {
      await respondToInquiry(inquiry._id, {
        status: "Resolved",
        response:
          "Thank you for contacting MediTrack. Your inquiry has been resolved.",
      });
            ...
            <div className="flex flex-wrap gap-2">
              ...
              >
                ...
                <option value="Technical Support">
                  Technical Support ({getCategoryCount("Technical Support")})
                </option>
                <option value="Payment Issue">
                  Payment Issue ({getCategoryCount("Payment Issue")})
                </option>
                <option value="Delivery Issue">
                  Delivery Issue ({getCategoryCount("Delivery Issue")})
                </option>
                <option value="Billing">
                  Billing ({getCategoryCount("Billing")})
                </option>
                <option value="Product Issue">
                  Product Issue ({getCategoryCount("Product Issue")})
                </option>
                <option value="Other">
