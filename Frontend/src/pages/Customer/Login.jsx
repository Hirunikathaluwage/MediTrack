    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder={userType === 'admin' ? 'admin@gmail.com' : 'your@email.com'}
                    required
        ...
        <div className="text-center mt-6 text-gray-500 text-sm">
          ...
          {userType === 'admin' && (
            <>
              Need administrator access? <a href="/contact" className="text-blue-600 hover:underline">Contact support</a>
            </>
          )}
        </div>
      </div>
...
// Add these custom animations to your global CSS or tailwind.config.js if not already added
// @keyframes fadeIn {
